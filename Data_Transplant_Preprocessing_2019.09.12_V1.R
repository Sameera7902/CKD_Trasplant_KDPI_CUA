...
### Parse as dates
ymd("2013-04-28")
transplant_deceased_cl_selected$transplantdate = ymd(transplant_deceased_cl_selected$transplantdate)
transplant_deceased_cl_selected$graftfailuredate = ymd(transplant_deceased_cl_selected$graftfailuredate)
transplant_deceased_cl_selected$endtransplantdate = ymd(transplant_deceased_cl_selected$endtransplantdate)
transplant_deceased_cl_selected$lastfollowupdate = ymd(transplant_deceased_cl_selected$lastfollowupdate)
transplant_deceased_cl_selected$deathdate = ymd(transplant_deceased_cl_selected$deathdate)
transplant_deceased_cl_selected$transplantdate = ymd(transplant_deceased_cl_selected$transplantdate)
transplant_deceased_cl_selected$deathdate = ymd(transplant_deceased_cl_selected$deathdate)
